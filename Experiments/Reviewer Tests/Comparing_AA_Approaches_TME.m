...
%--------------------------------------------------------------------------
figure(1);
semilogy(err_iter_full,'r-','LineWidth',1.5);
hold on;
semilogy(err_iter_slide,'b-','LineWidth',1.5);
hold on;
semilogy(err_iter_restart,'k-','LineWidth',1.5);
title('AA Variant Comparision (TME)','FontSize',14,'FontWeight','bold');
ylabel('Fixed-Point Error','FontSize',14,'FontWeight','bold');
xlabel('Iterations','FontSize',14,'FontWeight','bold');
legend({'Full-Memory','Sliding(m)','Restart(m)'},'FontSize',14,'FontWeight','bold');

figure(2);
semilogy(full_matrix_err,'r-','LineWidth',1.5);
hold on;
semilogy(slide_matrix_err,'b-','LineWidth',1.5);
hold on;
semilogy(restart_matrix_err,'k-','LineWidth',1.5);
title('AA Variant Comparision (TME)','FontSize',14,'FontWeight','bold');
ylabel('Solution Error (cov)','FontSize',14,'FontWeight','bold');
xlabel('Iterations','FontSize',14,'FontWeight','bold');
legend({'Full-Memory','Sliding(m)','Restart(m)'},'FontSize',14,'FontWeight','bold');
