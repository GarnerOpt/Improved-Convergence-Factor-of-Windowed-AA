%==========================================================================
% Anderson Acceleration Algorithm for fixed-point problems
%==========================================================================

%--------------------------------------------------------------------------
% Description:
%--------------------------------------------------------------------------
% This algorithm implements Algorithm 1 in the paper. The algorithm is 
...
%  m       - positive integer             - depth of the algorithm 
...
function [xfinal, x_iter, err_iter, runtime] = AA_Rn(q, q_data, x0, m, beta, maxiter, tol)
    tic; 
    ...
    while (k <= maxiter) && (err_iter(end) >= tol)
        ...
        err_iter(k+1) = norm(qX{end}-X{end},2);
